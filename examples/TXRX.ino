...
void setup() 
{
    ...
    Serial.println(F("qitas: CC1101 radio initialized."));
    delay(1000);
}
...
void loop() 
{
    ...
    if (now > lastSend) 
    {
        ...
        sprintf(tx_payload, "Message # %d from device %d. Hello %d.", tx_counter++, THIS_DEVICE_ADDRESS, RECEIVING_DEVICE_ADDRESS);
